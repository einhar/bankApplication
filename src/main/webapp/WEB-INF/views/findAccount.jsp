...
<body>
	...
	$(document).ready(function($) {
	    console.log("Jestem w $(document).ready(function($)!");
		$('#divResults').hide();
		$('#divError').hide();
	...
	function enableSearchButton(flag) {
	    console.log("Jestem w enableSearchButton(flag)!");
		$("#btn-search").prop("disabled", flag);
	}
	function searchViaAjax() {
	    console.log("Jestem w searchViaAjax()!");
		var accnt = {}
		accnt["accountNo"] = $("#accountNo").val();
		console.log("accnt['accountNo']:");
		console.log(accnt["accountNo"]);
		$.ajax({
			type : "POST",
	...
	function display(data) {
	    console.log("Jestem w display(data)!");
